...
namespace AzureTestSite.Controllers
{
    ...
    {
        private RepositoryBase<Post> repo;
        private readonly RepositoryBase<Comment> commentRepo;

        public PostsController(RepositoryBase<Post> repo, RepositoryBase<Comment> commentRepo)
        {
            this.repo = repo;
